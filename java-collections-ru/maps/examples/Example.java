...
public class Example {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Используя List, мы определили модель авто: "
                + model);
...
//
        ...
        System.out.println("Используя Map, мы определили модель авто: "
                + modelFromMap);
        System.out.println("Используя Map, мы определили модель авто: "
                + cars.get("O025XE700"));
//
...
//
//
        System.out.println("contains key = Max ? - "
                + people.containsKey("Max"));
        System.out.println("contains value = 2010 ? - "
                + people.containsValue(2021));
//
...
//        }
        ...
        for (Map.Entry<String, String> student: students.entrySet()) {
            System.out.println(
                "Student name is = " + student.getKey()
...
//
    ...
    /**
     * Метод возвращает заполненный список строк в заданном формате:
     * [госномер номер]:[марка автомобиля].
    ...
    private static String getModelByPlateNumber(String plateNumber) {
        ...
        for (String car : getCarsList()) {
            ...
            // проверяем, госномер элемента списка совпадает с переданным
